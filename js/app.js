(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".tabs-catalog__body")) new core(".tabs-catalog__body", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        if (document.querySelector(".feedback__swiper")) new core(".feedback__swiper", {
    ...
    const script_form = document.querySelector(".header__form");
    const searchButton = document.querySelector(".header__search");
    if (searchButton) searchButton.addEventListener("click", (function(e) {
        script_form.classList.toggle("_formActive");
        searchButton.classList.toggle("_none");
        headerMenu.classList.toggle("_none");
    }));
    window["FLS"] = true;
    isWebp();
    menuInit();
